...
class TagController {
    constructor() {
        this.findTags = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const tags = yield this.tagService.findTags();
        ...
        this.tagService = tag_service_1.default.getInstance();
    }
}
